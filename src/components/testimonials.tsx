...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "I have put off writing this testimonial because Michael is my closest and one of my oldest friends. I wanted my testimonial to be powerful and perfect. Perfection is impossible and it stands in the way of authentic expression. Michael's Contact Improv courses helped me understand this in my core. It's one thing to understand a concept intellectually, but it is entirely different to feel a concept in your body and nervous system. The Art of Living has given me practices that allow me to experience authentic expression in ways I have never been able to. Beyond how fun it is to dance and move with a wonderful community, Contact Improv has countless parallels to a healthy and joyful life. Some of my favorite highlights: moving at the speed of trust, not just trust in ourselves, but trust in our partners. We are dancing our own dance with another person that is dancing their own dance. We must not get lost in the other person's dance, and we should be aware if they are getting lost in our dance. When you learn how to fall safely, you're no longer afraid of doing so. In fact, falling becomes part of the dance. Sharing weight is necessary in order to truly feel where your partner is, and for them to feel where you are. Witnessing is just as important as experiencing. Trust allows you to move in ways that are impossible to do alone. All of these enriching ideas were taught while doing something incredibly fun. From simple weight sharing on the floor to lifting a partner on our shoulders, honing our attention to a single point in our body to taking in the whole room of dancers at once. Michael has a gift for walking the class through processes that build up over the day and weeks. One moment you have no idea what you are doing and the next you are moving in ways you have never moved before. All with grace, patience, and a lot of fun. There is a lot of laughing in the classes. There are the occasional tears. Engaging with this practice can bring up a lot of emotions, but it's all part of the dance. The community that has come up around Michael's classes dives into all of it with sincere support. It's beautiful. Michael is also a student himself. He often travels abroad to study under different teachers. He is so lit up when he comes back and talks about what he has learned and how excited he is to implement the lessons into his next series. He is adamant about his students going off and learning under as many different teachers as they can. I'm bias, given that I have known this man since we were 12 years old. But I feel confident in saying that Michael has a gift for learning and teaching this practice. If you have the opportunity to do so, I strongly recommend that you give yourself the chance to experience one of his classes.",
  },
  {
    name: "Matt Koch",
  ...
  },
  {
    ...
    text: "For some time, I have been curious how dance might help me feel more grounded and how it might help me to process different patterns, themes, feelings in my life…I'm happy to have dipped my toe into that exploration in the supportive, accepting space that Michael cultivates in his classes…I still don't fully understand what's happening in me during and after the classes I've taken with Michael, but I know that they have left me feeling lighter than I have felt in a long time and I am trying to trust that. I am grateful for the vulnerability of the people with whom I've shared classes, the simple act of being there, showing up and trying this art form and practice is so courageous. I'm grateful for the gentle, enthusiastic guidance and encouragement Michael has given us all in experimenting and learning more about moving together like this…both my classmates and Michael have helped me feel more comfortable and safe exploring this new piece of life. Wholeheartedly…all of us being ourselves makes space for all of us to be ourselves more freely. For anyone new to contact improv, speaking as someone who is very new to contact improv and any organized dance, I would highly recommend taking a course with Michael. It has been fun, silly, serious, heart opening, informative, and resonant. Thank you, Michael. Thank you, classmates.",
  },
  {
    name: "Karina Okoren",
